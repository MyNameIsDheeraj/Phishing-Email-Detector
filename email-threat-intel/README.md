...
## Directory Overview
- **`backend/`**: FastAPI python server, local SQLite database, heuristic rule engines, DNS verification packages, and unit tests.
- **`frontend/`**: React SPA dev server powered by Vite.
